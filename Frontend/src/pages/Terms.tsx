    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="border-muted/40 bg-muted/10">
            ...
            <p>
              Welcome, if you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern ZincAi relationship with you in relation to this website.
            </p>
            
            <p>
              The term 'ZincAi' or 'us' or 'we' refers to the owner of the website. The term 'you' refers to the user or viewer of our website.
            </p>
            ...
            <div>
              ...
              <ul className="space-y-3 list-disc list-inside">
                ...
                <li>You may not create a link to this website from another website or document without ZincAi prior consent.</li>
